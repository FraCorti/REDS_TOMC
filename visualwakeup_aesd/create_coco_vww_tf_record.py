...
sys.path.append(f"{os.getcwd()}visual_wake_words/visualwakeup_aesd/lib/object_detection/")

from visual_wake_words.visualwakeup_aesd.lib.object_detection.dataset_tools import tf_record_creation_util
from visual_wake_words.visualwakeup_aesd.lib.object_detection.utils import dataset_util
from visual_wake_words.visualwakeup_aesd.lib.object_detection.utils import label_map_util
...
tf.flags.DEFINE_integer('min_area', 96 * 48,
                        'Minimum area of bounding box. Smaller bounding boxes will be filtered out')
...
def create_tf_examples(image,
    ...
    for i, object_annotations in enumerate(annotations_list):
        if ann_is_valid(object_annotations, image_height, image_width, min_area) and ann_is_person(object_annotations,
                                                                                                   category_index):
